...
API_KEY = "Z58M-P9UE-97HT-DWEI"
STATION_ABBR = "ROCK"  # Embarcadero station
...
try:
    s3.upload_file(f"{now}-ROCK-data.json", "bart-station-data", f"rockridge/{filename}")
    os.remove(filename)
