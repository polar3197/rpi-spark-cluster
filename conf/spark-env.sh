...
# - SPARK_MASTER_HOST=0.0.0.0            #, to bind the master to a different IP address or hostname
# - SPARK_MASTER_PORT=7077 
# - SPARK_MASTER_WEBUI_PORT=8080       #, to use non-default ports for the master
# - SPARK_MASTER_OPTS, to set config properties only for the master (e.g. "-Dx=y")
# - SPARK_WORKER_CORES=2            #, to set the number of cores to use on this machine
# - SPARK_WORKER_MEMORY=2800m           #, to set how much total memory workers have to give executors (e.g. 1000m, 2g)
# - SPARK_WORKER_PORT
# - SPARK_WORKER_WEBUI_PORT       #, to use non-default ports for the worker
